...
function getCmClass(name, values) {
  ...
  case 'color':
    ...
    break;
  case 'activeline':
    return ' .CodeMirror-activeline-background { background: ' + values  + ' !important; }';
    break;
  case 'selected':
...
exports.create = function (theme) {
  ...
  if (theme.gutter) {
    if (theme.gutter.selectionBackground || theme.gutter.selectionForeground) {
      var gutterResult = cssClass + ' .CodeMirror-activeline .CodeMirror-gutter-elt,\n' +
                         cssClass + ' .CodeMirror-activeline .CodeMirror-gutter-elt .CodeMirror-foldgutter-folded,\n' +
                         cssClass + ' .CodeMirror-activeline .CodeMirror-gutter-elt .CodeMirror-foldgutter-open { ';
      ...
      if (theme.gutter.selectionBackground) {
        gutterResult += 'background: ' + theme.gutter.selectionBackground + '; '
    ...
    result += cssClass + ' .CodeMirror-gutters { ' + convertToCss(theme.gutter) + ' }\n'
  };
